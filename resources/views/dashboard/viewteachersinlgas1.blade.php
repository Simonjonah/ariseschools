                  ...
                  <tbody>
                    ...
                    @foreach ($view_headmasters as $view_headmaster)
                      <tr>
                        ...
                        @else
                        <td><a href="{{ url('web/schoolsteachers/'.$view_headmaster->slug) }}" target="_blank" rel="noopener noreferrer">{{ $view_headmaster->school['schoolname'] }}</a></td>
                        ...
                        <td>{{ $view_headmaster->fname }}
                          <small>
                          <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success">
                            Search For School
                          </button></small>
                        </td>
                        <td>{{ $view_headmaster->ref_no }}</td>
                        <td>{{ $view_headmaster->schooltype }}
                          <small>{{ $view_headmaster->classname }}</small>
                        </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-success">
      ...
      <div class="modal-body">
        <form action="{{ url('web/reachresultbyteacherschead') }}" method="post">
          @csrf
            ...
            @if (Auth::user()->schooltype == 'SUBEB')
              @foreach ($view_schools as $view_school)
                    @if ($view_school->schooltype == 'SUBEB')
                      <option value="{{ $view_school->id }}">{{ $view_school->schoolname }}</option>
                    @else
