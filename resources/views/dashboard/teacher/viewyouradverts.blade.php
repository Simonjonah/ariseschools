              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @if (Session::get('success'))
                    ...
                    @if ($view_myblog->school_id == Auth::guard('teacher')->user()->school_id)
                        ...
                        <tr>
                          ...
                          <td>@if ($view_myblog->status == null)
                            ...
                            @endif</td>
                          <td><a href="{{ url('teacher/viewadverts/'.$view_myblog->slug1) }}"
                            class='btn btn-default'>
                             ...
                             <td> <div class="input-group-prepend">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown-item"><a href="{{ url('teacher/editadvert/'.$view_myblog->ref_no) }}">Edit</a></li>
                                    <li class="dropdown-item"><a href="{{ url('teacher/approveadvert/'.$view_myblog->slug1) }}">Approved</a></li>
                                  <li class="dropdown-item"><a href="{{ url('teacher/suspendadvert/'.$view_myblog->slug1) }}">Suspend</a></li>
                                  <li class="dropdown-item"><a href="{{ url('teacher/rejectadvert/'.$view_myblog->slug1) }}">Reject</a></li>
                                  <li class="dropdown-item"><a href="{{ url('teacher/deletesadvert/'.$view_myblog->ref_no) }}">Delete</a></li>
