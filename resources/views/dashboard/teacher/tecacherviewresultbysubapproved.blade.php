                      ...
                      <tbody>
                        ...
                        @endphp
                          ...
                          <tr>
                              ...
                              <td>{{ $view_myresult_result->middlename }}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Seach Student Term</h4>
        ...
        <form action="{{ url('teacher/searchforstudentresult') }}" method="post">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="regnumber">
              @foreach ($view_myresult_results as $view_myresult_result)
                <option value="{{ $view_myresult_result->regnumber }}">{{ $view_myresult_result->regnumber }}</option>
