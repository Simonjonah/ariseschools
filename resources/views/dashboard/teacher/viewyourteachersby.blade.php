                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($view_myteachers as $view_myteacher)
                      @if ($view_myteacher->school['ref_no1'] == Auth::guard('teacher')->user()->school['ref_no1'] && $view_myteacher->school['connect'] == Auth::guard('teacher')->user()->school['connect'] && $view_myteacher->schoolname == Auth::guard('teacher')->user()->schoolname && $view_myteacher->address == Auth::guard('teacher')->user()->address && $view_myteacher->lga == Auth::guard('teacher')->user()->lga)
                        <tr>
                          ...
                          <ul class="dropdown-menu">
                            <!-- <li class="dropdown-item"><a href="{{ url('teacher/edittteachertr/'.$view_myteacher->ref_no) }}">Edit</a></li> -->
                            <li class="dropdown-item"><a href="{{ url('teacher/approveteacherbytr/'.$view_myteacher->ref_no) }}">Approved</a></li>
                            <li class="dropdown-item"><a href="{{ url('teacher/viewtteachertr/'.$view_myteacher->ref_no) }}">View</a></li>
                          </ul>
                        </div></td>
