                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @endif
                    ...
                    @foreach ($view_primarypupils as $view_primarypupil)
                      @if ($view_primarypupil->school['section'] ==  Auth::guard('teacher')->user()->school['section']  && $view_primarypupil->school['address'] ==  Auth::guard('teacher')->user()->school['address'] && $view_primarypupil->school['lga'] ==  Auth::guard('teacher')->user()->school['lga'] && $view_primarypupil->school['connect'] ==  Auth::guard('teacher')->user()->school['connect']) 
                        <tr>
