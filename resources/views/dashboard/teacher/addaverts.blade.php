        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('teacher/createschoolnews') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  {{-- @method('PUT') --}}
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" name="schoolname" value="{{ Auth::guard('teacher')->user()->school['schoolname'] }}" id="">
                        <input type="hidden" name="address" value="{{ Auth::guard('teacher')->user()->school['address'] }}" id="">
                        <input type="hidden" name="email" value="{{ Auth::guard('teacher')->user()->email }}" id="">
                        <input type="hidden" name="phone" value="{{ Auth::guard('teacher')->user()->phone }}" id="">
                        <input type="hidden" name="logo" value="{{ Auth::guard('teacher')->user()->logo }}" id="">
                        <input type="hidden" name="slug" value="{{ Auth::guard('teacher')->user()->school['slug'] }}" id="">
