            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="table-responsive">
                  ...
                  <form action="{{ url('teacher/createpsychomotorom') }}" method="post" enctype="multipart/form-data">
                    @csrf
                  ...
                  @endif
                    ...
                    <table class="table table-bordered">
                      ...
                      @foreach ($view_domains as $view_domain)
                        ...
                        <tr>
                      <input type="hidden" name="regnumber[]" value="{{ $add_psychomotor->regnumber }}">
                      <input type="hidden" name="student_id[]" value="{{ $add_psychomotor->student_id }}">
                        <input type="hidden" name="school_id[]" value="{{ $add_psychomotor->school_id }}">
                        <input type="hidden" name="classname[]" value="{{ $add_psychomotor->classname }}">
                        <input type="hidden" name="user_id[]" value="{{ $add_psychomotor->user_id }}">
                        <input type="hidden" name="term[]" value="{{ $add_psychomotor->term }}">
                        <input type="hidden" name="section[]" value="{{ $add_psychomotor->section }}">
                        <input type="hidden" name="cogname[]" value="{{ $view_domain->cogname }}">
                        <input type="hidden" name="psycomoto[]" value="{{ $view_domain->psycomoto }}">
                        <input type="hidden" name="teacher_id[]" value="{{ $add_psychomotor->teacher_id }}">
                      <input type="hidden" name="alms[]" value="{{ $add_psychomotor->alms }}">
