                            ...
                            <tbody>
                                ...
                                @foreach ($view_teachersubjects as $view_teachersubject)
                                  ...
                                  <tr>
                                    ...
                                    <input type="text" name="lga[]" value="{{ Auth::guard('teacher')->user()->lga }}" placeholder="Teacher ID">
                                    ...
                                    <input type="text" name="section[]" value="{{ $view_studentsubject->section }}" placeholder="Teacher ID">
                                    ...
                                    <input type="hidden" name="slug[]" value="{{ $view_studentsubject->slug }}" placeholder="ID">
                                  ...
                                  @elseif ($view_teachersubject->section == 'Secondary')
                                  <tr>
                                    <td>{{ $view_teachersubject->subjectname }}<input type="text" value="{{ $view_teachersubject->subjectname }}" name="subjectname[]" id=""></td>
                                    ...
                                    <input type="text" name="user_id[]" value="{{ Auth::guard('teacher')->user()->id }}" placeholder="Teacher ID">
                                    <input type="text" name="student_id[]" value="{{ $view_studentsubject->id }}" placeholder="ID">
                                    <input type="text" name="term[]" value="{{ $view_studentsubject->term }}" placeholder="Term">
                                    <input type="text" name="academic_session[]" value="{{ $view_studentsubject->academic_session }}" placeholder="academic_session">
                                    <input type="text" name="regnumber[]" value="{{ $view_studentsubject->regnumber }}" placeholder="regnumber">
                                    {{-- <input type="text" name="guardian_id[]" value="{{ $view_studentsubject->guardian_id }}" placeholder="Parent ID"> --}}
                                    <input type="text" name="classname[]" value="{{ $view_studentsubject->classname }}" placeholder="Parent ID">
                                    <input type="text" name="fname[]" value="{{ $view_studentsubject->fname }}" placeholder="Parent ID">
                                    <input type="text" name="middlename[]" value="{{ $view_studentsubject->middlename }}" placeholder="Parent ID">
                                    <input type="text" name="surname[]" value="{{ $view_studentsubject->surname }}" placeholder="Parent ID">
                                    <input type="text" name="gender[]" value="{{ $view_studentsubject->gender }}" placeholder="Parent ID">
                                    <input type="text" name="images[]" value="{{ $view_studentsubject->images }}" placeholder="Parent ID">
                                    <input type="text" name="logo[]" value="{{ Auth::guard('teacher')->user()->logo }}" placeholder="Parent ID">
                                    <input type="text" name="schoolname[]" value="{{ Auth::guard('teacher')->user()->schoolname }}" placeholder="Parent ID">
                                       
                                  </tr>
                                    @elseif ($view_teachersubject->section == 'Junior Secondary')
                                    <tr>
                                    <td>{{ $view_teachersubject->section }} {{ $view_teachersubject->subjectname }}<input type="text" value="{{ $view_teachersubject->subjectname }}" name="subjectname[]" id=""></td>
                                    <td><input type="number" class="form-control" name="test_1[]" placeholder="Test 1"></td>
                                    <td><input type="number" class="form-control" name="test_2[]" placeholder="Test 2"></td>
                                    <td><input type="number" class="form-control" name="test_3[]" placeholder="Test 3"></td>
                                    <td><input type="number" class="form-control" name="exams[]" placeholder="Exams"></td>
