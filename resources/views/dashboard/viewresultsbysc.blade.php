@include('dashboard.header')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">Arise School</a>.</strong> All rights
    reserved.
  </footer>
          ...
          <form action="{{ url('web/reachresultbystudentsc') }}" method="post">
            ...
            <div class="form-group">
                <select name="regnumber" class="form-control" id="">
                    @foreach ($view_allresults as $view_allresult)
                        <option value="{{ $view_allresult->regnumber }}">{{ $view_allresult->surname }} {{ $view_allresult->fname }} {{ $view_allresult->regnumber }}</option>
                    @endforeach
            ...
            <div class="form-group">
              <select name="classname" class="form-control" id="">
                @foreach ($view_allresults as $view_classe)
