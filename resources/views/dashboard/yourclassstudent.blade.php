                    ...
                    @foreach ($view_secondarystudents as $view_secondarystudent)
                      {{-- @if ($view_secondarystudent->section == Auth::guard('web')->user()->section &&  $view_secondarystudent->school_id == Auth::guard('web')->user()->school_id) --}}
                        <tr>
                          ...
                          <td>{{ $view_secondarystudent->surname }}
                            <small>{{ $view_secondarystudent->schoolname }}</small>
                          </td>
    ...
    <div class="modal-dialog">
      <div class="modal-content bg-success">
        ...
        <div class="modal-body">
          <form action="{{ url('web/reachresultbystudentss') }}" method="post">
            @csrf
            <div class="form-group">
                <select name="schoolname" class="form-control" id="">
                    @foreach ($view_secondarystudents as $view_secondarystudent)
                        <option value="{{ $view_secondarystudent->schoolname }}">{{ $view_secondarystudent->schoolname }}</option>
                    @endforeach
            ...
            <div class="form-group">
              ...
              @if (Auth::user()->schooltype == 'SUBEB')
                @foreach ($view_secondarystudents as $view_secondarystuden)
                      @if ($view_secondarystuden->section == 'Primary')
                        <option value="{{ $view_secondarystuden->classname }}">{{ $view_secondarystuden->classname }}</option>
                      @else
              ...
              @else
                ...
                @foreach ($view_secondarystudents as $view_secondarystuden)
                      @if ($view_secondarystuden->section == 'Secondary')
                        <option value="{{ $view_secondarystuden->classname }}">{{ $view_secondarystuden->classname }}</option>
                      @else
            ...
            <div class="form-group">
                <select name="academic_session" class="form-control" id="">
                    @foreach ($view_secondarystudents as $view_secondarystudent)
                        <option value="{{ $view_secondarystudent->academic_session }}">{{ $view_secondarystudent->academic_session }}</option>
                    @endforeach
            ...
            <div class="form-group">
                <select name="lga" class="form-control" id="">
                    @foreach ($view_secondarystudents as $view_secondarystudent)
                        <option value="{{ $view_secondarystudent->lga }}">{{ $view_secondarystudent->lga }}</option>
                    @endforeach
