        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('web/updatetransfer/'.$transfer_principal->ref_no) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="school_id" id="">
                            @foreach ($all_schools as $all_school)
                                @if ($all_school->schooltype == 'SUBEB')
