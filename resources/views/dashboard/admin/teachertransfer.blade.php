        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/updatetransfersprinc/'.$transfer_principal->ref_no) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <option value="{{ $transfer_principal->id }}">{{ $transfer_principal->schoolname }} LGA {{ $transfer_principal->lga }}  {{ $transfer_principal->address }} </option>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <option value="{{ $transfer_principal->lga }}">{{ $transfer_principal->lga }} </option>
