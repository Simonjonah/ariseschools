        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <h3 class="card-title"><td><a href="{{ url('admin/subebheadmaster/'.$view_students->lga) }}" class="btn btn-primary">View Primary School Headmasters</a></td></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($view_headmasters as $view_headmaster)
                        ...
                        <td><a href="{{ url('admin/viewprinci/'.$view_headmaster->ref_no) }}"
                          class='btn btn-default'>
                           <i class="far fa-eye"></i>
                       </a></td>
                       <td><a href="{{ url('admin/editprinci/'.$view_headmaster->ref_no) }}"
                        class='btn btn-info'>
                     ...
                     <td> <div class="input-group-prepend">
                        ...
                        <ul class="dropdown-menu">
                          <li class="dropdown-item"><a href="{{ url('admin/princisaddmit/'.$view_headmaster->ref_no) }}">Approved</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/rejectprinci/'.$view_headmaster->ref_no) }}">Reject</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/suspendprinci/'.$view_headmaster->ref_no) }}">Suspend</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/tranfer/'.$view_headmaster->ref_no) }}">Transfer</a></li>
                          <li class="dropdown-item"><a href="{{ url('admin/retired/'.$view_headmaster->ref_no) }}">Retired</a></li>
                        </ul>
                      </div></td>
                

                   <td><a href="{{ url('admin/princidelete/'.$view_headmaster->ref_no1) }}"
